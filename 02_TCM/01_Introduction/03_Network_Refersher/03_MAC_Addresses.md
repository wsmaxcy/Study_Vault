...
How we know what device is what

Each NIC (Network Interface Card) has a MAC address. This utilizes layer 2 and how we communicate over switches

Mac addresses have identifiers

00:00:00:AA:AA:AA

the first part has Identifies. Each company has an identifier and are assigned the first 3 pairs of the MAC address
